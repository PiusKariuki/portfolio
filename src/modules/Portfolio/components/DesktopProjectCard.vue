<template>
  <div class="flex items-center relative w-full">
    <img
        :src="item.image"
        alt=""
        :class="[isEven ? '' :'ml-auto']"
        class="opacity-10 hover:opacity-100 bg-green-tint rounded-lg h-full w-7/12">

        <div
            :class="[!isEven ? 'items-start text-left' : 'right-0 items-end  text-right']"
            class="flex flex-col  z-10 w-6/12  gap-4 absolute top-1/2 -translate-y-1/2">
          ...
          <div
              ...
              class="bg-light-navy rounded-lg flex justify-end items-center w-full hover:shadow-2xl py-4 lg:py-12 px-4 ">
...
<script setup>
const props = defineProps(['isEven', 'item'])
</script>